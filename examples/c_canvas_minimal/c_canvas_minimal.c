...
int main(int argc, const char **argv) {
    ...
    // Clear to white.
    PFGLDeviceClear(PFGLRendererGetDevice(renderer), &(PFClearParams){0});
    ...
    PFRenderOptions render_options = {0};
    PFSceneProxyBuildAndRenderGL(scene_proxy, renderer, &render_options);
